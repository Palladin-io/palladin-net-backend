...
namespace Palladin.Module.Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911214227_AddConsentActivationRevision")]
    partial class AddConsentActivationRevision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Palladin.Module.Identity.Domain.UserConsent", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<long>("ActivationRevision")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("UserId", "Purpose");

                    b.ToTable("UserConsents");
                });

            modelBuilder.Entity("Palladin.Module.Identity.Domain.UserConsentHistory", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("UserId", "Purpose", "Revision");

                    b.HasIndex("UserId", "Purpose", "RequestId")
                        .IsUnique();

                    b.ToTable("UserConsentHistory");
                });
            ...
            modelBuilder.Entity("Palladin.Module.Identity.Domain.UserConsentHistory", b =>
                {
                    b.HasOne("Palladin.Module.Identity.Domain.UserConsent", null)
                        .WithMany()
                        .HasForeignKey("UserId", "Purpose")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
