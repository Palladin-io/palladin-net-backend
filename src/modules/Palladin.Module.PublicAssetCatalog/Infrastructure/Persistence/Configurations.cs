...
internal sealed class PublicAssetConfiguration : IEntityTypeConfiguration<PublicAsset>
{
    ...
    {
        b.HasKey(x => x.Id); b.Property(x => x.Name).HasMaxLength(200); b.Property(x => x.Status).IsConcurrencyToken(); b.Property(x => x.AcquisitionScheduledAt).IsConcurrencyToken();
